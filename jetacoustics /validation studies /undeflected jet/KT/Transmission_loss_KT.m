...
%r = 1.4;
W = 0.056;                 %input('Width of the sheet(in m) :') ;(2.5)  2pir
L = 0.075;
h = 1e-3;                %input("Thickness of the material(in m)[..,..,..] :");(20e-03)
C_air = 340 ;            % Velocity of sound in the air( in m/sec)
rho_air = 1.225 ;        % density of air in kg/m^3                         
damping_ratio = 0.0025;  % damping ratio of aluminum (0.0025 used in simulation)
z = rho_air*C_air;                                                                                          
