function [TL,Com,f_c,f_natural] = Transmission_loss_GI_sheet(f_signal)
...
%r = 1.4;
W = 17;                 %input('Width of the sheet(in m) :') ;(2.5)  2pir
L = 23;
h = 0.5e-3;                %input("Thickness of the material(in m)[..,..,..] :");(20e-03)
