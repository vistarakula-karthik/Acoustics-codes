function [TL,Com,f_c,f_natural] = Transmission_loss(f_signal)
...
nu = 0.303;              %nu = input('Poisson ratio of the material :');      
L = 8.4;                 %input('Length of the sheet(in m) :');(2.5)
W = 8.4;                 %input('Width of the sheet(in m) :') ;(2.5)
h = 20e-3;                %input("Thickness of the material(in m)[..,..,..] :");(20e-03)
