...
E = 200e9;               %E = input('Provide the young modulas of the material( in Pa) :'); %Pa
nu = 0.27;              %nu = input('Poisson ratio of the material :');      
%L = 19.761;                 %input('Length of the sheet(in m) :');(2.5)  length of booster
r = 1.4;
%W = 2*pi*r;                 %input('Width of the sheet(in m) :') ;(2.5)  2pir
h = 6e-3;                %input("Thickness of the material(in m)[..,..,..] :");(20e-03)
