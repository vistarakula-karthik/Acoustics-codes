...
alpha = 0;                             
M = 1.301228628;         %0.8;             % 0.95; 
T_infty = 221.4636;       %264.5762469;     %253.72544;
u_infty = M*sqrt(1.4*287*T_infty);                     % 264.43           % As per the simulation data
rho_infty = (0.338802931);       %0.593246144;        %0.503358164;              
nu = 0.00004273702512;      %0.00002820623496;          %0.00003214958791;
